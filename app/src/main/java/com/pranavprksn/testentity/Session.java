...
public class Session {
    ...
    public PreKeySignalMessage encrypt(String message) throws UntrustedIdentityException {
        ...
        try {
            ...
            System.out.println("INSIDE SESSION: raw -> " + Arrays.toString(rawCiphertext));
            //System.out.println("INSIDE SESSION: encrypted -> " + encrypted);
            //System.out.println("INSIDE SESSION: ciphertext -> " + ciphertext);
            System.out.println("INSIDE SESSION: message -> " + message);
    ...
    public String decrypt(PreKeySignalMessage ciphertext) {
        ...
        try {
            ...
            //System.out.println("INSIDE SESSION D: raw -> " + ciphertext);
            System.out.println("INSIDE SESSION: decrypted -> " + Arrays.toString(decrypted));
            //System.out.println("INSIDE SESSION: ciphertext -> " + ciphertext);
            System.out.println("INSIDE SESSION D: message -> " + new String(decrypted, UTF8));
